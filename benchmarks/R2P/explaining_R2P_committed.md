## R2P Implementation (Committed Fix, pre-refactoring): Joint State-Dependent Alive Region

**This is the committed fix (commit `722a145`), before the `ComputeR2PAliveRegion` refactoring. Algorithmically identical to the refactored version — Steps 1–5 are duplicated in both call sites instead of shared.**

**PR:** https://github.com/lucasmt/separation-grk/pull/3
...
**Structure:** Steps 1–5 are the same logic, but duplicated — once in **ComputeCoveredRegion** (`src/CycleCover.cpp:207-293`) and once in **ComputeCycleStrategy** (`src/CycleCover.cpp:79-137`). They diverge at Step 6.
...
**Implementation:**
- `HasCycle`: `src/CycleCover.cpp:139-144`
- In `ComputeCoveredRegion`: `src/CycleCover.cpp:267-271`
- In `ComputeCycleStrategy`: `src/CycleCover.cpp:112-116`
...
**Implementation:**
- In `ComputeCoveredRegion`: `src/CycleCover.cpp:273-276`
- In `ComputeCycleStrategy`: `src/CycleCover.cpp:118-121`
...
**Implementation:**
- In `ComputeCoveredRegion`: `src/CycleCover.cpp:278`
- In `ComputeCycleStrategy`: `src/CycleCover.cpp:123`
...
**Implementation (the full fused loop):**
- In `ComputeCoveredRegion`: `src/CycleCover.cpp:263-279`
- In `ComputeCycleStrategy`: `src/CycleCover.cpp:106-124`
...
**Implementation:**
- `ComputeStateDependentAliveRegion`: `src/CycleCover.cpp:168-180`
...
- Called in `ComputeCoveredRegion`: `src/CycleCover.cpp:282-283`
- Called in `ComputeCycleStrategy`: `src/CycleCover.cpp:126-127`
...
**Implementation:** `src/CycleCover.cpp:286-289`
...
**Implementation:**
- Guard and call site: `src/CycleCover.cpp:129-133`
- `ComputeR2PPathStrategy` (builds two-phase strategy): `src/CycleCover.cpp:182-205`
